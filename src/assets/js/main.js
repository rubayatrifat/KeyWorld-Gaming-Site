...
(function ($) {
  ...
  //     cssEase: 'ease',
  //     touchThreshold: 100,
  //     prevArrow: '<button type="button" class="slick-prev wow fadeInLeft"><i class="ti-shift-left"></i></button>',
  //     nextArrow: '<button type="button" class="slick-next wow fadeInRight"><i class="ti-shift-right"></i></button>',
  //     responsive: [
